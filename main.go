...
func init() {
	...
	utilruntime.Must(nanopodv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "274c5f9c.nanopod.treezh.cn",
	...
	if err = (&controllers.NanoPodReconciler{
